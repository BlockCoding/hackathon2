...
const checkMTNparamters = ["0803", "0703", "0903", "2340806"];
...
const sendMail = () => {
 ...
 <img class="network_image" src="https://adeptadvisory.co.za/wp-content/uploads/2019/12/mtn_logo-1.jpg" alt="MTN Network">
 </div>`;
 } else if (checkGloparameters.includes(PhoneNumberEl.value)) {
  NetworkNumberEl.innerHTML = `<div>
  <img class="network_image" src="https://www.bing.com/images/search?view=detailV2&ccid=nqZEAhrr&id=39BD29D9C87BD95D54B6DDE66E89593338259E85&thid=OIP.nqZEAhrrzB_KQtEIlWdNUAHaHJ&mediaurl=https%3a%2f%2folorisupergal.com%2fwp-content%2fuploads%2f2018%2f09%2fGlo-logo1.png&cdnurl=https%3a%2f%2fth.bing.com%2fth%2fid%2fR.9ea644021aebcc1fca42d10895674d50%3frik%3dhZ4lODNZiW7m3Q%26pid%3dImgRaw%26r%3d0&exph=994&expw=1030&q=glo+Logo&simid=608022126620116613&FORM=IRPRST&ck=730E8A760029A699371A8A81C1F6ABFF&selectedIndex=0" alt="Glo network">
  </div>`;
 } else if (check9mobileParameters.includes(PhoneNumberEl.value)) {
  NetworkNumberEl.innerHTML = `<div>
  <img class="network_image src="https://th.bing.com/th/id/R.8c85eba6cc09e117a49a9ffad9837578?rik=Z%2bGcF%2fjABaEwPQ&pid=ImgRaw&r=0" alt="9mobile Network">
  </div>`;
 } else if( checkAirtelParameter.includes(PhoneNumberEL.value)) {
  NetworkNumberEl.innerHTML = `<div>
  <img class="network_image" src="https://th.bing.com/th/id/R.7ef1457acf52b43f6abd9d9a5fb04bfb?rik=n9mJ58pjrYm9jw&pid=ImgRaw&r=0" alt="Airtel Network">
  </div>`;
 } else {
